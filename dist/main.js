...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\nvar form = document.getElementById(\"form\");\nvar container = document.getElementById(\"container\");\nvar teleport = document.getElementById(\"scoreTeleport\");\nvar summary = document.createElement(\"p\");\ncontainer.appendChild(summary);\nvar categoriesNode = document.createElement(\"ul\");\ncontainer.appendChild(categoriesNode);\nvar errorMessage = document.createElement(\"p\");\ncontainer.appendChild(errorMessage);\nvar loadingMessage = document.createElement(\"p\");\nloadingMessage.innerHTML = \"loading... ...\";\n\nfunction resetUI() {\n  summary.innerHTML = \"\";\n  teleport.innerHTML = \"\";\n  categoriesNode.innerHTML = \"\";\n  errorMessage.innerHTML = \"\";\n}\n/* GET DATA */\n\n\nvar getData = function getData(e) {\n  e.preventDefault();\n  resetUI();\n  attachLoading();\n  var city = document.getElementById(\"cityInput\").value.toLowerCase().split(\" \").join(\"-\");\n  axios__WEBPACK_IMPORTED_MODULE_0___default().get(\"https://api.teleport.org/api/urban_areas/slug:\".concat(city, \"/scores/\")).then(function (res) {\n    writeHTML(res);\n  })[\"catch\"](function (error) {\n    console.log(error);\n    writeError(error);\n  })[\"finally\"](function () {\n    removeLoading();\n  });\n};\n\nform.addEventListener(\"submit\", getData);\n/* WRITE HTML */\n\nvar attachLoading = function attachLoading() {\n  container.appendChild(loadingMessage);\n};\n\nvar removeLoading = function removeLoading() {\n  container.removeChild(loadingMessage);\n};\n\nvar writeError = function writeError(errorObject) {\n  var error = errorObject.message;\n\n  if (errorObject.code === \"ERR_BAD_REQUEST\") {\n    error = \"Error: City not found \";\n  }\n\n  errorMessage.innerHTML = error;\n};\n\nvar writeHTML = function writeHTML(resObject) {\n  summary.innerHTML = resObject.data.summary;\n  teleport.innerHTML = \"Teleport city score\" + \" : \" + resObject.data.teleport_city_score.toFixed(2);\n  var categories = resObject.data.categories;\n  var categoriesContent = \"\";\n\n  for (var i = 0; i < categories.length; i++) {\n    var color = categories[i].color;\n    var name = categories[i].name;\n    var score = categories[i].score_out_of_10.toFixed(2);\n    categoriesContent += \"<li style=\\\"color:\".concat(color, \"\\\"> <p style=\\\"color:white\\\">\").concat(name, \" - \").concat(score, \"</p></li>\");\n  }\n\n  categoriesNode.innerHTML = categoriesContent;\n};\n\n//# sourceURL=webpack://my-webpack-project/./src/index.js?");
